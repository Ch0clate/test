...
public interface CarConstants extends Constants {
	...
	public static final String PRODUCT_CAR = "CARS";	
	public static final String PRODUCT_NAME_BRMS = "Cars";
	public static final String PROD_CATEG_SUBTYPE_CAR = "Car";
	...
	public static final String JSON_PROP_ADDANCILLARY= "addAncillary";
	public static final String JSON_PROP_REMOVEANCILLARY = "removeAncillary";
	public static final String JSON_PROP_UPDATEPAXINFO = "updatePaxInfo";
	public static final String JSON_PROP_CHAGERENTALINFO = "changeRentalInfo";
	public static final String JSON_PROP_UPGRADECAR = "upgradeCar";
	public static final String JSON_PROP_FULLCANCEL = "fullCancel";
