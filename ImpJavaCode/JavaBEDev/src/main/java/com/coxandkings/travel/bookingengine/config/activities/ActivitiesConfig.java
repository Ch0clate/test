...
import com.coxandkings.travel.bookingengine.orchestrator.activities.ActivityService;
...
public class ActivitiesConfig {
	...
	public static void loadConfig() {
		...
		Document configDoc = MongoProductConfig.getConfig(ActivityService.PRODUCT);
